package com.beiyuan.appyujing.animation;
	...
	public static void startAnimationsIn(ViewGroup viewgroup, int durationMillis) {
		for (int i = 0; i < viewgroup.getChildCount(); i++) {
			...
			MarginLayoutParams mlp = (MarginLayoutParams) inoutimagebutton
					.getLayoutParams();
			Log.i("myLog", "mlp.rightMargin=" + mlp.rightMargin
					+ "; mlp.bottomMargin=" + mlp.bottomMargin);
			Animation animation = new TranslateAnimation(mlp.rightMargin
					- xOffset, mlp.rightMargin - xOffset, 0F, yOffset
					+ mlp.bottomMargin);
