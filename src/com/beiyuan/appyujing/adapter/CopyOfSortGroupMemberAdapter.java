...
public class CopyOfSortGroupMemberAdapter extends BaseAdapter implements
		SectionIndexer {
	private List<GroupMemberBean> list = null;
	private Context mContext;

	public CopyOfSortGroupMemberAdapter(Context mContext,
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(
					R.layout.activity_group_member_item_copy, null);
		...
		viewHolder.phone.setText(this.list.get(position).getPhone());
