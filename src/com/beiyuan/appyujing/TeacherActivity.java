...
public class TeacherActivity extends FragmentActivity implements
		OnClickListener {
	...
	private AdapterView.OnItemClickListener onTeacherItemClickListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> adapterView, View view, int i,
			...
			switch (i) {
			case 0:
				intent = new Intent(TeacherActivity.this,
						UpdateInfoActivity.class);
				startActivity(intent);
				break;
			case 1:
				intent = new Intent(TeacherActivity.this, HelpActivity.class);
				startActivity(intent);

				break;
			case 2:
				intent = new Intent(TeacherActivity.this, AboutUsActivity.class);
				startActivity(intent);
	...
	private void initView() {
		...
		mTabHost.setup(TeacherActivity.this, getSupportFragmentManager(),
				R.id.realtabcontent);
		// 得到fragment的个数
