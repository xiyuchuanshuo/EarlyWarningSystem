...
import com.beiyuan.appyujing.fragment.AttendanceFragment;
import com.beiyuan.appyujing.fragment.EmergencyFragment;
import com.beiyuan.appyujing.fragment.GaodeMapFragment;
import com.beiyuan.appyujing.fragment.MapTeacherFragment;
...
public class HeadteacherActivity extends FragmentActivity implements
		OnClickListener {

	// 加载各个模块
	public static final Class[] fragments = { VoiceFragment.class,
			NewsFragment.class, GaodeMapFragment.class,
			EmergencyFragment.class,AttendanceFragment.class };
	...
	public void initTheSideView() {
		head_img = (CircularImage) findViewById(R.id.teacher_main_logo);
		exit_txt = (TextView)findViewById(R.id.exit_txt);
		user_nickname = (TextView) findViewById(R.id.teacher_main_name);
		user_nickname.setText(GlobalData.getUsername());
		listView = (ListView) findViewById(R.id.lv);
		listView.setAdapter(new ArrayAdapter<String>(this,
				android.R.layout.simple_expandable_list_item_1,
				getStudentData()));
		listView.setOnItemClickListener(onTeacherItemClickListener);
	...
	private AdapterView.OnItemClickListener onTeacherItemClickListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> adapterView, View view, int i,
			...
			switch (i) {
			case 0:
				intent = new Intent(HeadteacherActivity.this,
						UpdateInfoActivity.class);
				startActivity(intent);
				break;
			case 1:
				intent = new Intent(HeadteacherActivity.this, HelpActivity.class);
				startActivity(intent);

				break;
			case 2:
				intent = new Intent(HeadteacherActivity.this, AboutUsActivity.class);
				startActivity(intent);
	...
	private void initView() {
		...
		mTabHost.setup(HeadteacherActivity.this, getSupportFragmentManager(),
				R.id.realtabcontent);
		// 得到fragment的个数
		...
		mRadioButton5 = (RadioButton) findViewById(R.id.tab_rb_5);
